    ...
    public class Recaptcha
    {
        ...
        public static class V3
        {
            ...
            public static class Enterprise
            {
                ...
                public static IEnumerable<object[]> Uris()
                {
                    yield return new[] { new CaptchaUri(W1, Type) };
                }
            ...
            public static class NonEnterprise
            {
                ...
                {
                    yield return new[] { new CaptchaUri(W1, Type) };
                    yield return new[] { new CaptchaUri(W2, Type) };
                }
        ...
        public static class V2
        {
            ...
            public static class NonEnterprise
            {
                ...
                public static IEnumerable<object[]> Uris()
                {
                    yield return new[] { new CaptchaUri(W1, Type) };
                    yield return new[] { new CaptchaUri(W2, Type) };
                    yield return new[] { new CaptchaUri(W3, Type) };
                }
                ...
                public const string W3 = "https://www.weebly.com/";
            }
        }
    }
